...
프로젝트에 대한 상세한 문서는 `docs/` 디렉토리에서 확인할 수 있습니다:

- **[아키텍처 문서](./docs/ARCHITECTURE.md)** - 시스템 아키텍처, 계층 구조, 도메인 모델 등
- **[API 설계 문서](./docs/API_DESIGN.md)** - REST API 엔드포인트, 인증/인가, 에러 처리 등
- **[개발 가이드](./docs/DEVELOPMENT.md)** - 개발 환경 설정, 코딩 컨벤션, 테스트 작성 가이드 등
